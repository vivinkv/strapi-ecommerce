...
export interface ApiAddToCartAddToCart extends Struct.CollectionTypeSchema {
...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    add_to_carts: Schema.Attribute.Relation<
      'oneToMany',
      'api::add-to-cart.add-to-cart'
    >;
    ...
    publishedAt: Schema.Attribute.DateTime;
    reset: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    reset_time: Schema.Attribute.Time;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    purity: Schema.Attribute.Decimal &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
